...
# energy per toggle in Joules ( E = 0.5 * C * V^2 ), a bit like kinetic energy
...
def plot_power_profile(x, y):
    ...
    plt.tight_layout()
    plt.savefig("vcd_power_consumption_estimation_s1.png")
    plt.show()


if __name__ == "__main__":
    VCD_FILE = "RECEPTEUR_QKD/RECEPTEUR_QKD.sim/sim_1/behav/xsim/test_vcd_s1.vcd" # Change to your file name
