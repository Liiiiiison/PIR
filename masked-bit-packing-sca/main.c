...
int main(int argc, char* argv[]) {
	...
	unsigned long key1_fixed = 0b10010110100100000000001101100000;// 0100 0000 0010 0000 0011 0000 0100 0000;
	unsigned long key2_fixed = 0b10110010100100000000001100100000;//0100 0000 0010 0000 0001 0001 0100 0000; 
	...
	system_set_register(7,masked_key);
	system_set_register(28,mask);
